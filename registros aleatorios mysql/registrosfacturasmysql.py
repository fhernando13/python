...
for i in range(1,1001):       
    ...
    try:
        with conexion.cursor() as cursor:
            ...
            sql = 'insert into factura_abrilmayo (numCliente, fecha, hora, noVendedor, monto, iva, total, tipoPago) values (%s, %s, %s, %s, %s, %s, %s, %s)'
            cursor.execute(sql, (numCliente, fechafac, hora, noVendedor, monto, iva, total, pago))
            conexion.commit()
